...
from .views import (
    ...
    AutoHoursTemplateDuplicateView,
    AutoHoursTemplateDuplicateDefaultView,
...
urlpatterns = [
    ...
    path('project-templates/<int:template_id>/duplicate/', AutoHoursTemplateDuplicateView.as_view(), name='project_template_duplicate'),
    path('project-templates/duplicate-default/', AutoHoursTemplateDuplicateDefaultView.as_view(), name='project_template_duplicate_default'),
