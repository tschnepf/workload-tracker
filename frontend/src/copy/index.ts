...
export const COPY = {
  ...
  'deliverables.return': 'Return',
  'deliverables.modeBundle': 'Live source',
  'deliverables.modeLegacy': 'Legacy source',
  'deliverables.modeFallback': 'Fallback source',
  'deliverables.degradedWarning': 'Degraded data source active',
  'deliverables.partialWarning': 'Partial results shown',
  ...
  'deliverables.autoRotate': 'Auto-rotating every 20s',
