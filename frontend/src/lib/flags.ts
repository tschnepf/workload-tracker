...
const FLAG_ENV_MAP = {
  ...
  FF_NAV_PENDING_UNIFIED: 'VITE_FF_NAV_PENDING_UNIFIED',
  FF_UI_BOOTSTRAP: 'VITE_FF_UI_BOOTSTRAP',
  FF_DIALOG_SYSTEM: 'VITE_FF_DIALOG_SYSTEM',
  FF_PAGE_STATE_PRIMITIVES: 'VITE_FF_PAGE_STATE_PRIMITIVES',
  FF_PAGE_ERROR_BOUNDARY_ROUTES: 'VITE_FF_PAGE_ERROR_BOUNDARY_ROUTES',
  FF_TOAST_QUEUE: 'VITE_FF_TOAST_QUEUE',
  FF_ASSIGNMENTS_AUTO_HOURS_BUNDLE: 'VITE_FF_ASSIGNMENTS_AUTO_HOURS_BUNDLE',
  FF_PEOPLE_SKILLS_SETTINGS_SNAPSHOTS: 'VITE_FF_PEOPLE_SKILLS_SETTINGS_SNAPSHOTS',
  FF_MODERATE_PAGES_SNAPSHOTS: 'VITE_FF_MODERATE_PAGES_SNAPSHOTS',
  FF_DASHBOARD_RGL: 'VITE_FF_DASHBOARD_RGL',
  FORECAST_PLANNER_V2: 'VITE_FORECAST_PLANNER_V2',
  FORECAST_PLANNER_CHARTS_V1: 'VITE_FORECAST_PLANNER_CHARTS_V1',
